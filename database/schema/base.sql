-- Canonical base schema for fresh MOZacad installations.
-- This file represents the runtime-aligned database state and removes
-- the requirement to replay the full historical migration chain.
...
ALTER TABLE coupon_usage_logs
    ...
    ADD CONSTRAINT fk_coupon_usage_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL;
