    ...
    public function compose(array $blueprint, array $rules, array $briefing): array
    {
        ...
        foreach ($blueprint as $i => $section) {
            ...
            $prompts[] = $globalContext . "\n\n"
                ...
                . "Para secções de desenvolvimento/análise, aumentar densidade argumentativa: incluir confronto explícito entre autores, enquadramento histórico-crítico e leitura sociopolítica com marcadores temporais/espaciais concretos.\n"
                ...
                . "Se a secção for de objectivos específicos, formular cada objectivo com verbo de acção, objecto analítico delimitado, recorte metodológico e pertinência científica explícita.\n"
