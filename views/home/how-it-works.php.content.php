<div class="page-header"><div class="page-intro"><h1 class="section-title h3">Como funciona</h1><p>Fluxo acompanhado pela equipa para transformar um briefing inicial num documento final pronto para defesa.</p></div></div>
...
['4','Preparação e upload manual','Após o pagamento, a equipa recebe o pedido, prepara o documento e faz o upload manual para revisão.'],
